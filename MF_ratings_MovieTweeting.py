...
if __name__ == "__main__":
    ...
    df_all_predictions.to_csv(
        f"prediction_all/MovieTweeting/mf_MovieTweeting.csv", index=False)
    print("Top K..........")
    evaluation = []
    x = range(1, 21)
    for k in x:
    ...
    df_eval.to_csv(
        f"result_evaluation/MovieTweeting/mf_MovieTweeting.csv", index=False)
    plt.ylim(0, 1)
    ...
    fig = ax.get_figure()
    name_fig = f"evaluation/MovieTweeting/mf_MovieTweeting.png"
    print(name_fig)
